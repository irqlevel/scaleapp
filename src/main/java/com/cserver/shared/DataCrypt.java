...
public class DataCrypt {
	...
	static public byte[] RsaEncryptData(long pubKeyId, long pubKeyOwner, 
		...
		try {
			...
			if (dataHash == null) {
				if (debug)
					SLog.e(TAG, "RsaEncryptData:dataHash is null");
				return null;
			}
	        ...
	        if (sign == null) {
	        	if (debug)
	        		SLog.e(TAG, "RsaEncryptData:dataSign is null");
	        	return null;
	        }
	        ...
	        if (encryptedData == null) {
	        	if (debug)
	        		SLog.e(TAG, "RsaEncryptData:encryptedData is null");
	        	return null;
	        }
			...
			SLog.e(TAG, "RsaEncryptData:encryptData exception=" + e.toString());
	...
	static public byte[] RsaDecryptData(byte[] encrypted, IKeyResolver keyResolver) {
		...
		try {
			...
			if (encryptedDataLength <= 0 || signLength <= 0) {
				if (debug)
					SLog.e(TAG, "AesDecryptData:encrypted data length mismatch");
				return null;
			}		
			...
			if (privKey == null) {
				if (debug)
					SLog.e(TAG, "Cant get private key for keyOwner=" + pubKeyOwner + " pubKeyId=" + pubKeyId);
	        	return null;	
			}
			...
			if (data == null) {
				if (debug)
					SLog.e(TAG, "AesDecryptData:decryptData is null");
	        	return null;
			}
			...
			if (signKey == null) {
				if (debug)
					SLog.e(TAG, "AesDecryptData:not found key with id=" + signKeyId + " owner=" + signKeyOwner);
				return null;
			}
			...
			if (dataHash == null) {
				if (debug)
					SLog.e(TAG, "AesDecryptData:dataHash is null");
				return null;
			}
			...
			if (plainSign == null) {
				if (debug)
					SLog.e(TAG, "AesDecryptData:plainSign is null");
				return null;
			}

			if (!Arrays.equals(plainSign, dataHash)) {
				if (debug)
					SLog.e(TAG, "AesDecryptData:data sign is not correct");
				return null;	
			}
						
		} catch (Exception e) {
			SLog.e(TAG, "AesDecryptData:decryptData exception=" + e.toString());
			SLog.exception(TAG, e);
		}
	...
	static public byte[] AesEncryptData(byte[] aesKey, long signOwner, long signKeyId, 
		...
		try {
			if (aesKey.length != AES_KEY_LENGTH) {
				if (debug)
					SLog.e(TAG, "AesEncryptData:aesKey length mistmatch");
				return null;
			}
			...
			if (dataHash == null) {
				if (debug)
					SLog.e(TAG, "AesEncryptData:dataHash is null");
				return null;
			}
	        ...
	        if (sign == null) {
	        	if (debug)
	        		SLog.e(TAG, "AesEncryptData:dataSign is null");
	        	return null;
	        }
	        ...
	        if (encryptedData == null) {
	        	if (debug)
	        		SLog.e(TAG, "AesEncryptData:encryptedData is null");
	        	return null;
	        }
			...
			SLog.e(TAG, "AesEncryptData:encryptData exception=" + e.toString());
			SLog.exception(TAG, e);
		}
	...
	static public byte[] AesDecryptData(byte[] aesKey, byte[] encrypted, IKeyResolver keyResolver) {
		...
		try {
			...
			if (ivLength != IV_LENGTH) {
				if (debug)
					SLog.e(TAG, "AesDecryptData:ivLength mismatch");
				return null;
			}
			...
			if (signLength <= 0 || dataLength <=0) {
				if (debug)
					SLog.e(TAG, "AesDecryptData:decrypted data length mismatch");
				return null;
			}
			...
			if (signKey == null) {
				if (debug)
					SLog.e(TAG, "AesDecryptData:not found key with id=" + signId);
				return null;
			}
