...
public class SLog {
    ...
    private static volatile SLog instance;
	...
	public static void e(String tag, String message) {
		SLog.getInstance().errorMessage(tag, message);
	}
	
	public static void i(String tag, String message) {
		SLog.getInstance().infoMessage(tag, message);
	}

	public static void v(String tag, String message) {
		SLog.getInstance().verboseMessage(tag, message);
	}
	
	public static void d(String tag, String message) {
		SLog.getInstance().debugMessage(tag, message);
	}
	
	public static void exception(String tag, Exception e) {
		SLog.getInstance().exceptionMessage(tag, e);
	}
	
	public static void throwable(String tag, Throwable t) {
		SLog.getInstance().throwableMessage(tag, t);
	}
	
	
	public static void start(boolean releaseBuild, String logPath, SPostLogger postLogger) {
		SLog.getInstance().startInstance(releaseBuild, logPath, postLogger);
	}
	...
	public static String getLastLines(int numLines) {
		return SLog.getInstance().instanceGetLastLines(numLines);
	}
}
